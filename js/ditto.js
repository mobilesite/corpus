...
function router() {
    ...
    $.get(path, function (data) {
        ...
        commentLink = '<div style="margin-top: 50px;margin-bottom: 0px;padding-top: 20px;padding-bottom: 0px;text-align: left;border-top: 1px dotted #777;"></div><div class="margin-bottom: 10px;"><span style="font-size: 16px;">☞</span><a style="margin-left:5px;color: #4682BE;text-decoration: none;" class="comment-link" href="./comments.html?id='+ id +'&title='+ title +'&url='+ url +'">评论与反馈</a></div><div><span style="font-size: 16px;">☞</span><a style="margin-left:5px;color: #4682BE;text-decoration: none;" class="comment-link" href="//mobilesite.github.io">博客首页</a></div>'
